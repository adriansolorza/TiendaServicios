...
namespace TiendaServicios.Api.Libro.Test
{
    public class LibrosServiceTest
    {
        ...
        public async Task GetLibrosAsync() {
            ...
            // que metodo dentro de mi MS esta encargado de la consulta de libros en la BD?

            // 1. emular una instancia de ef core
            //    para emular las acciones y eventos utilizamos mock

            //Emula el contexto de BD
            var mockContexto = CrearContexto();

            //Emula al mapping IMapper
            var mapConfig = new MapperConfiguration(cfg => {
                cfg.AddProfile(new MappingTest());
            });
            var mapper = mapConfig.CreateMapper();
            //Instanciar la clase Manejador y pasarle los mocks que he crado
